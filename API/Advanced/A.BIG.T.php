...
header("Location:".'http://'.$_SERVER['SERVER_NAME']."/Rule/Advanced/A.BIG.T.php?Logo=$Logo&Rule=$Rule&Apple=$Apple&Group=$Group&DNS1=$DNS1&DNS2=$DNS2&Config1=$Config1&Config2=$Config2&Config3=$Config3&Config4=$Config4&Config5=$Config5&Flag1=$Flag1&Flag2=$Flag2&Flag3=$Flag3&Flag4=$Flag4&Flag5=$Flag5");
?>